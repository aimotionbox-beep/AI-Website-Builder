...
export function getInMap(obj: any, path: any): any;
...
export function hasTriple(store: any, [e, a, v]: [any, any, any]): boolean;
export function hasEntity(store: any, e: any): boolean;
export function createStore(attrs: any, triples: any, enableCardinalityInference: any, linkIndex: any, useDateObjects: any): {
    eav: Map<any, any>;
    aev: Map<any, any>;
    vae: Map<any, any>;
};
export function retractTriple(store: any, rawTriple: any): void;
export function addTriple(store: any, rawTriple: any): void;
