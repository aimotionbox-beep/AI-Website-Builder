...
const instaql_js_1 = __importStar(require("./instaql.js"));
...
function queryEntity(sub, store) {
    const res = (0, instaql_js_1.default)({ store, pageInfo: null, aggregate: null }, sub.query);
...
function sortEntitiesInPlace(sub, orderFieldType, entities) {
    ...
    if (sub.orderField === 'serverCreatedAt') {
        entities.sort(sub.orderDirection === 'asc'
            ? function compareEntities(a, b) {
                return (0, instaql_js_1.compareOrder)(a.entity.id, a.serverCreatedAt, b.entity.id, b.serverCreatedAt, dataType);
            }
    ...
    entities.sort(sub.orderDirection === 'asc'
        ? function compareEntities(a, b) {
            return (0, instaql_js_1.compareOrder)(a.entity.id, a.entity[field], b.entity.id, b.entity[field], dataType);
        }
        : function compareEntities(b, a) {
            return (0, instaql_js_1.compareOrder)(a.entity.id, a.entity[field], b.entity.id, b.entity[field], dataType);
        });
